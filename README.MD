...
Apri direttamente `lambda-calcolo.html` nel browser — nessun server, nessuna dipendenza locale.
...
│                                                         │
│  ┌──────────────────┬───────────────────┬────────┐      │
│  │ CONCETTO         │ DESCRIZIONE       │ AZIONI │      │
│  ├──────────────────┼───────────────────┼────────┤      │
│  │ Astrazione Lambda│ Il cuore del...   │  [🔍]  │      │
│  │ Applicazione     │ Applicare una...  │  [🔍]  │      │
│  │ Currying         │ Il lambda calc... │  [🔍]  │      │
│  │ ...              │ ...               │  [🔍]  │      │
│  └──────────────────┴───────────────────┴────────┘      │
└─────────────────────────────────────────────────────────┘
```
